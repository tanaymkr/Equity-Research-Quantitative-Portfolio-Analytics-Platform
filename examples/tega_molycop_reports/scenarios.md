...
| --- | --- | --- | --- | --- |
| Downside | Equity shortfall under stress | -18,255.08 | 14.0% | 3.0% |
| Base | INR 311.41 | 23,395.29 | 12.0% | 4.0% |
| Upside | INR 969.72 | 72,852.88 | 10.5% | 4.5% |

FY2027 is April 2026–March 2027. Molycop is consolidated June–March (10 months). Actual June is retained; only July–March (9 months) is discounted as future cash flow. The legacy business similarly excludes its actual April–June quarter. End-period discounting uses actual days / 365. Operating schedules support one combined DCF; they are not separately valued. The cash flows used for valuation are ownership-adjusted economic amounts, not statutory consolidated statements.
...
- [Upside forecast and schedules](upside/forecast.md)

## Estimated opening funding bridge (INR million)

| Item | Amount |
| --- | --- |
| march unrestricted liquidity | 23,141.97 |
| new parent loan | 15,000.00 |
| tega equity contribution cash outflow | 37,446.24 |
| q1 operating cash estimate | 599.36 |
| q1 cash capex estimate | 949.70 |
| q1 transaction fee cash assumption | 56.52 |
| q1 principal estimate | 125.94 |
| other cash movement estimate | 0.00 |
| cash before liquidity topup | 162.93 |
| required opening liquidity topup estimate | 337.07 |
| opening cash estimate | 500.00 |
| opening gross debt including leases estimate | 19,195.14 |
| opening net debt including leases estimate | 18,695.14 |
| jv book value proxy | 282.06 |
| investment property book value proxy | 43.08 |

## One-at-a-time base sensitivity

Rates are decimals. All other assumptions remain at base. No probabilities assigned.

| Input changed | Value | INR/share |
| --- | --- | --- |
| Group WACC | 0.1050 | 691.33 |
| Group WACC | 0.1200 | 311.41 |
| Group WACC | 0.1400 | 0.00 |
| Group terminal growth | 0.0300 | 268.81 |
| Group terminal growth | 0.0400 | 311.41 |
| Group terminal growth | 0.0450 | 336.38 |
| Group terminal ROIC | 0.1300 | 240.62 |
| Group terminal ROIC | 0.1600 | 311.41 |
| Group terminal ROIC | 0.1800 | 345.49 |
| Preference current fair value (INR m) | 25,641.90 | 311.41 |
| Preference current fair value (INR m) | 31,340.10 | 247.56 |
| Preference current fair value (INR m) | 37,988.00 | 173.07 |
| Other claims reserve (INR m) | 0.00 | 364.61 |
| Other claims reserve (INR m) | 4,748.50 | 311.41 |
| Other claims reserve (INR m) | 9,497.00 | 258.20 |
| Earnout cash payment (INR m) | 0.00 | 353.52 |
| Earnout cash payment (INR m) | 5,698.20 | 311.41 |
| Earnout cash payment (INR m) | 11,396.40 | 269.29 |
| Legacy Q1 cash flow estimate (INR m) | 0.00 | 303.43 |
| Legacy Q1 cash flow estimate (INR m) | 600.00 | 311.42 |
| Legacy Q1 cash flow estimate (INR m) | 1,200.00 | 319.40 |
| Molycop forecast NWC / revenue | 0.1800 | 350.57 |
| Molycop forecast NWC / revenue | 0.2000 | 311.41 |
| Molycop forecast NWC / revenue | 0.2300 | 252.66 |
| Molycop FY26 EBITDA operating adjustment (INR m) | -949.70 | 218.77 |
| Molycop FY26 EBITDA operating adjustment (INR m) | 0.00 | 311.41 |
| Molycop FY26 EBITDA operating adjustment (INR m) | 949.70 | 404.05 |
| Cost savings after FY2027 / base ramp | 0.0000 | 190.93 |
| Cost savings after FY2027 / base ramp | 0.5000 | 251.17 |
| Cost savings after FY2027 / base ramp | 1.0000 | 311.41 |
...
- 2026-06-01: [Final acquisition closing filing](https://www.tegaindustries.com/assets/pdfs/int/2026/Q1/20260602_065818.pdf) — pages 1-8 (`closing`).
...
- 2026-06-02: [FY2026 earnings call](https://www.tegaindustries.com/assets/pdfs/int/2026/Q1/20260608_232901.pdf) — printed pages 5-9, 12-14; newer August guidance takes precedence (`fy26_call`).
- 2026-06-16: [S&P final Molycop debt rating rationale](https://www.spglobal.com/ratings/en/regulatory/article/-/view/type/HTML/id/3581730) — financing, earnout and rating-adjusted debt; agency estimates are not audited accounts (`sp`).
- 2026-05-19: [ICRA Tega financing rationale](https://www.icra.in/Rating/ShowRationalReportFilePdf/143093) — pages 1 and 7; preference cash deferral and parent loan maturity; pre-closing (`icra`).
- 2026-08-22: [Proposed Apollo preferential cash issue](https://www.tegaindustries.com/assets/pdfs/int/2026/Q2/20260822_115252.pdf) — pages 1-4; subject to approvals, not issued shares (`pending_issue`).
- 2026-09-08: [Clarification of proposed allottee ownership](https://www.tegaindustries.com/assets/pdfs/int/2026/Q2/20260908_125014.pdf) — page 1; does not announce completed allotment (`sept_update`).
- 2026-09-02: [Reuters: Indian rupee closing exchange rate](https://www.reuters.com/world/india/rbis-bid-lift-indian-rupee-put-test-by-oil-us-yields-2026-09-02/) — September 2 closing rate: INR94.97 per US dollar; market close, not the official reference fixing (`fx_20260902`).